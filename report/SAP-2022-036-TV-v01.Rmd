...
- Target population size (chosen): `r N`
- True population prevalence (assumed): `r Py |> philsfmisc::format.pct(0)`
- Tolerance (chosen): `r epsilon |> philsfmisc::format.pct(0)`
- Diagnostic sensitivity (chosen): `r se |> philsfmisc::format.pct()`
- Diagnostic specificity (chosen): `r sp |> philsfmisc::format.pct()`
